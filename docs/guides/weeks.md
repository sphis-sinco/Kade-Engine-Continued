...
1. The ability to compile from the source code. All information related to building Kade Engine is listed [here.](../building.md)
2. A text editor. Some form of IDE that can support Haxe is recommended, such as VSCodium.

---

### Step 1. Navigation

Navigate to the source code. In the `source` folder, look for `StoryMenuState.hx`. Open it in your text editor.
...
![weeks2](https://user-images.githubusercontent.com/55949451/122635129-763fa180-d0e2-11eb-841e-3456e74a50ba.png) \* _for this screenshot I removed tankman from weekCharacters as it would crash because I don't have a tankman character added_
